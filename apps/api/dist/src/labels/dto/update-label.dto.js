...
class UpdateLabelDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: false, type: () => String, minLength: 1, maxLength: 32 }, color: { required: false, type: () => String, pattern: "^#[0-9a-fA-F]{6}$" } };
    }
}
exports.UpdateLabelDto = UpdateLabelDto;
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Enhancement' }),
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: '#22c55e' }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
