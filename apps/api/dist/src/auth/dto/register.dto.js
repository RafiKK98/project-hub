...
class RegisterDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { email: { required: true, type: () => String, format: "email" }, name: { required: true, type: () => String, minLength: 2, maxLength: 64 }, password: { required: true, type: () => String, minLength: 8, maxLength: 128, pattern: "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)" } };
    }
}
...
__decorate([
    ...
    (0, class_validator_1.MaxLength)(128, { message: 'Password must be at most 128 characters' }),
